...
<body class="bg-light">
	...
	<div id="main" class="container">
		<div
			...
			<h1 class="display-4">Cliente Encontrado</h1>
		</div>
				...
				<div class="col-md-12 order-md-1">
					...
					<c:forEach var="cliente" items="${lista}">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-4">
								<label for="email">Telefone</label> <input type="text"
									...
									maxlength="20" value="${cliente.telefone}" readonly>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4 mb-3">
								<label for="country">Estado</label> <input type="text" value="${cliente.estado}"
					...
					<hr class="mb-4">
					<a class="btn btn-warning btn-block btn-md"
						href="alterar_cliente?id=${cliente.id}">Salvar Alterações</a>
					<button id="btn${cliente.id }%>" type="button"
						class="btn btn-danger btn-block btn-md" data-toggle="modal"
						data-target="#delete-modal" data-cliente="${cliente.id }">Remover
						Cliente</button>
				</div>
			</div>
		</c:if>
